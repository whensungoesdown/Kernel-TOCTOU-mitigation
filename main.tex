...
\addtolength{\abovecaptionskip}{-5pt} % 7pt
\addtolength{\belowcaptionskip}{-20pt}
\addtolength{\intextsep}{-5pt} % space left on top and bottom of an in-text float.
\addtolength{\textfloatsep}{-12pt} % 12pt  % space between last top float or first bottom float and the text.
...
% uty
\newcommand{\toolname}{\textsc{TTFuze}\xspace}
