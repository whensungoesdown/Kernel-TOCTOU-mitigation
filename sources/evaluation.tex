...
\hb{this should not appear }Our hypervisor is slower, particularly in two benchmark programs. Learning more about computer architecture and virtualization techniques, we wish to improve our hypervisor to achieve the same performance.
...
\begin{center}
	\begin{table}[ht]
		...
		\begin{tabular}{@{}>{\centering\arraybackslash}m{1.70cm}@{}|
