...
\begin{figure}[th]
  \includegraphics[width=0.47\textwidth]{pte}
  \centering
...
\begin{figure}[th]
  \includegraphics[width=0.47\textwidth]{denyuserwrite}
  \centering
  \caption{}
...
\begin{figure}[th]
  \includegraphics[width=0.45\textwidth]{pagestate}
  \centering
...
\begin{figure}[th]
  \includegraphics[width=0.47\textwidth]{reexecute}
  \centering
  \caption{}
  \label{fig:reexecute}
\end{figure}
...
\begin{comment}
\begin{figure}[th]
  \includegraphics[width=0.47\textwidth]{timeline}
  \centering
...
\begin{figure}[th]
  \includegraphics[width=0.47\textwidth]{processsmap}
  \centering
